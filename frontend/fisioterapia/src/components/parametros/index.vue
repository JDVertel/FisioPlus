                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-2">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <button type="button" class="btn btn-primary btn-sm" @click="uploadImage_p()">
                                                Actualizar
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="container mt-3">
                                        <button type="button" class="btn btn-primary btn-sm" @click="update_datosPagina()">
                                            Actualizar
                                        </button>
                                    </div>
                                </div>
                ...
                <div id="collapse5" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <!-- COMUNICACIONES -->
                            <div class="tab-pane fade" id="nav-comunicaciones" role="tabpanel" aria-labelledby="nav-comunicaciones-tab" tabindex="0">
                                comunicaciones
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        /*     update_datosEmpresa() {
                this.dataempresa.push({
                    nombre: this.nombreips,
                    nit: this.nit,
                    direccion: this.direccion,
                    celular: this.cel,
                    whapsapp: this.wsp,
                    logo: this.local_Image
                });
                console.log(this.dataempresa[0]);
            }, */
        ...
        async uploadImage_p() {
            try {
                ...
                this.B_guardarProductos(this.p_img);
            } catch (error) {
                console.error("Error uploading image:", error);
            }
        },

        B_guardarProductos(dataimg) {

            this.datosEmpresa.push({
                //cambiar variable por dinamica
                id_ips: "1",
                nombre: this.nombreips,
                nit: this.nit,
                direccion: this.direccion,
            ...
            this.createDataEmpresa(this.datosEmpresa[0]);
            console.log("guardando el registro", this.datosEmpresa);
            this.limpiarmodal();
        },
