...
<div>
        ...
        <div class="row vitrinahorizontal">
            <div class="col-12">
                <div class="card-container">
                    <div class="card mb-2" v-for="agenda in dataAgendas" :key="agenda.id" @click="verListadoReservasByIdAgenda(agenda)">
                  ...
                  theme_consulta: agenda.clase === 'consulta',
                            ...
                            <hr class="hrsencillo" />
                            <div class="container centradosombra">
                                <h6>{{ agenda.clase }}</h6>
                                <h6>{{ agenda.clasificacion }}</h6>
                            </div>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row mb-3">
                <button type="button" class="btn btn-warning btn-sm" @click="form_nuevoAgendamiento()" v-if="clase_agenda != ''">
                    <strong> <i class="bi bi-plus-circle"></i> Reservar {{ clase_agenda}} - {{ fecha_agenda }}</strong>
                </button>
            </div>
        </div>

        <div class="card mb-3" v-if="this.nuevoAgendamiento == true">
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="container-fluid centrarcontenido">
                            <div class="row mb-3">
                                <div class="col-4"> <strong>Usuario</strong>

                                    <tr v-for="pac in datapaciente" :key="pac.id">
                                        <div class="row centrarcontenido">
                                            {{ pac.numdoc }} <br>{{ pac.name1 }} {{ pac.apell1 }} </div>
                                ...
                                <div class="col-8">
                                    <div class="row">
                                      <div class="row"> <strong>Fecha/Tipo:</strong>{{ clase_agenda}} - {{ fecha_agenda }}</div>
                                        <div class="input-group input-group-sm mb-3">
                    ...
                    <!--  -->
                    <div class="container" style="background-color:#C1C1C1" v-if="this.dataAllCitasPaciente.length > 0">
                        <br />
                        <div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-6 col-md-3">
                            <select class="form-select form-select-sm textarea" id="inputGroupSelect_treserva" v-model="t_reserva" @change="filtarProf()">
                        ...
                        <div class="col-6 col-md-3">
                            <select class="form-select form-select-sm textarea" id="inputGroupSelect02" v-model="p_reserva" @change="filtrarFechasByProf()">
                                ...
                                <option v-for="profactivo in this.profactivos" :key="profactivo.id" :value="profactivo.id">
                        ...
                        <div class="col-6 col-md-3">
                            <select class="form-select form-select-sm textarea" id="miSelect" v-model="f_reserva" @change="VerListadoCitasAsignadas()">
                                ...
                                <option v-for="fecha in this.fechasActivas" :key="fecha.id" :value="fecha.id">
                                    {{ fecha.fecha }}
                                </option>
                            </select>
                        </div>
                        ...
                        <button type="button " class="btn btn-success btn-sm" :disabled="GuardarR_isButtonDisabled">
                            Guardar cita
                        </button>
                    </div>
                </div>
