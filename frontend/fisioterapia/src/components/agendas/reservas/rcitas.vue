...
<div>
    <div class="container">
        <strong>Listado de agendas disponible</strong>
        <p>
                ...
                <div class="card-container">
                  ...
                  theme_consulta: agenda.clase === 'consulta',
                            ...
                            <div class="container card_detalle">
                                <h6>{{ agenda.fecha }}</h6>
                                <p>{{ this.nombreProfesional(agenda.id_profesional) }}</p>
                                <hr class="hrsencillo" />
                            </div>
                            <hr class="hrsencillo" />
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row mb-3">
                <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal" @click="vaciarformbpaciente()" v-if="clase_agenda != ''">
                    <strong>
...
export default {
    ...
    methods: {
        ...
        /* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
        /* esta se busca en la primer consulta */
