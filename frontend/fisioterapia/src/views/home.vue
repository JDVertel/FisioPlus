    ...
    <div class="tab-content" id="myTabContent">
      ...
      >
        ...
        <div>
          ...
          <button
            class="btn btn-success btn-sm"
            @click="mostrartienda = !mostrartienda"
          >
